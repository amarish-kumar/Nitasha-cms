...
namespace NITASA.Helpers
{
    public class Imager
    {
        ...
        //Hard resize attempts to resize as close as it can to the desired size and then crops the excess
        public static System.Drawing.Image HardResizeImage(int Width, int Height, string imagePath)
        {
        ...
        //Image resizing by Path
        public static System.Drawing.Image ResizeImage(int maxWidth, int maxHeight, string imagePath)
        {
            Image Image = Image.FromFile(imagePath);
            int width = Image.Width;
            int height = Image.Height;
